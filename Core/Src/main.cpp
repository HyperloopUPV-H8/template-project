...
#define TEST_SIZE_ADC1  10

// ((Vin * 1.5164835) - 0.5) * 350 / 4
#define PREASSURE_1 &PB0
#define PREASSURE_2 &PB1
#define PREASSURE_3 &PF11
#define PREASSURE_4 &PF12

// ((Vin * 1.5164835) - 0.5) * 350 / 4
#define BRAKES_TEMPERATURE_1 &PF6
#define BRAKES_TEMPERATURE_2 &PF7
#define BRAKES_TEMPERATURE_3 &PF8
#define BRAKES_TEMPERATURE_4 &PF9
...
#define PWM_RED		PF3
#define PWM_GREEN	PF2
#define PWM_BLUE	PF1
#define ENV_TEMP		&PC2
#define ENV_PREASSURE	&PA0
#define REGULATOR_OUT	PB9
#define REGULATOR_IN	&PA4

Pin* test_pins_adc1[TEST_SIZE_ADC1] = { PREASSURE_1, PREASSURE_2, PREASSURE_3, PREASSURE_4,ENV_PREASSURE,REGULATOR_IN, &PA6, &PC0, &PA3, &PA5 };
uint8_t test_ids_adc1[TEST_SIZE_ADC1];
float test_results_adc1[TEST_SIZE_ADC1];

#define TEST_SIZE_ADC2  2
Pin* test_pins_adc2[TEST_SIZE_ADC2] = { &PF13, &PF14 };
uint8_t test_ids_adc2[TEST_SIZE_ADC2];
float test_results_adc2[TEST_SIZE_ADC2];

#define TEST_SIZE_ADC3  8
Pin* test_pins_adc3[TEST_SIZE_ADC3] = { BRAKES_TEMPERATURE_1, BRAKES_TEMPERATURE_2, BRAKES_TEMPERATURE_3, BRAKES_TEMPERATURE_4, ENV_TEMP, &PC3, &PF5, &PF10  };
uint8_t test_ids_adc3[TEST_SIZE_ADC3];
float test_results_adc3[TEST_SIZE_ADC3];
...
uint8_t red_duty_cycle = 100;
uint8_t green_duty_cycle = 100;
uint8_t blue_duty_cycle = 100;
void led_update() {
