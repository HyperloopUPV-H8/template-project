...
LogConf Log::config = LogConf::Error | LogConf::Fatal | LogConf::Console |
                      LogConf::File | LogConf::Info | LogConf::Debug;
...
std::string SPI::ip = "127.0.0.1";

SPI::Instance SPI::instance1 = {.SCK = &PC10,
                                .MOSI = &PC12,
                                .MISO = &PC11,
                                .SS = &PD3,
...
map<pair<Pin, Pin>, void *> Encoder::pin_timer_map = {{{PC6, PC7}, nullptr}};
...
map<uint16_t, ExternalInterrupt::Instance> ExternalInterrupt::instances = {
    {PE0.gpio_pin, Instance()}, {PE1.gpio_pin, Instance()}};
