...
void propagate_fault_callback();
void start_charging_obccu_callback();
void stop_charging_obccu_callback();
void open_contactors_obccu_callback();
void close_contactors_obccu_callback();
void brake_callback();
void unbrake_callback();
void set_regulator_pressure_callback();
void disable_emergency_tape_callback();
void enable_emergency_tape_callback();
void reset_vcu_callback();
void test_pwm_callback();
void test_current_control_callback();
void set_reset_on_callback();
void set_reset_off_callback();
void start_levitation_control_callback();
void start_vertical_levitation_callback();
void stop_levitation_callback();
void stick_down_callback();
void landing_callback();
void start_horizontal_levitation_callback();
void enter_testing_mode_callback();
void exit_testing_mode_callback();
void manual_zeroing_callback();
void set_stable_levitation_on_callback();
void set_stable_levitation_off_callback();
void set_rgb_color_callback();
void turn_on_party_callback();
void turn_off_party_callback();
void turn_on_pump_callback();
void turn_off_pump_callback();
void discharge_dclink_callback();
void change_position_references_callback();
void start_vf_control_callback();
void CRUISING_DEMONSTRATION_callback();
